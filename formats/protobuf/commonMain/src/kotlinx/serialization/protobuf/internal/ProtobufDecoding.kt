...
internal open class ProtobufDecoder(
    ...
    private val absenceReader: ProtobufAbsenceReader = ProtobufAbsenceReader(descriptor)
    ...
    override fun decodeElementIndex(descriptor: SerialDescriptor): Int {
        while (true) {
            ...
            if (protoId == -1) { // EOF
                return absenceReader.popUnmarkedIndex()
            }
    ...
    override fun decodeNotNullMark(): Boolean {
        return !absenceReader.popNullValue()
    }
}
